...
export default function UserLibrary({
  ...
  const [libraryType, setLibraryType] = useState("playlists");
  useEffect(()=>{
    const storedType = localStorage.getItem("libraryType");
    if (storedType) {
      setLibraryType(storedType);
    }
  },[])
  ...
  return (
    <div className="flex flex-col items-stretch flex-1 max-h-full px-2 py-4 overflow-y-hidden rounded-lg bg-red-200">
